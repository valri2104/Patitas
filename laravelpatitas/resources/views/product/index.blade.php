                                ...
                                <form method="GET" action="{{ route('product.index') }}"
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" id="search" name="q"
                                            value="{{ $viewData['searchTerm'] ?? '' }}" class="form-control"
                                        ...
                                        <div class="d-flex align-items-center mb-2 hover-shadow">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-success">
                                                    ${{ number_format($product->getPrice(), 0, ',', '.') }}</div>
                                            </div>
                                        </div>
                                    </a>
                                @endforeach
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="mb-3">
                                            <small class="text-muted">
                                                ...
                                                <span
                                                    class="fw-bold {{ $product->getStock() > 10 ? 'text-success' : ($product->getStock() > 0 ? 'text-warning' : 'text-danger') }}">
                                                    {{ $product->getStock() }}
                                                </span>
                                            </small>
                                        </div>
                                            ...
                                            @if ($product->isInStock())
                                                <form method="POST" action="{{ route('cart.add') }}">
                                                    ...
                                                    <button type="submit" class="btn btn-success">
                                                        <i
                                                            class="fas fa-shopping-cart me-2"></i>{{ __('app.products.actions.add_to_cart') }}
                                                    </button>
                                                </form>
                                            @else
                                                <button class="btn btn-secondary" disabled>
                                                    <i
                                                        class="fas fa-ban me-2"></i>{{ __('app.products.show.out_of_stock') }}
                                                </button>
                                            @endif
                                        </div>
                                    </div>
