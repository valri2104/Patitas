...
<head>
    ...
    <title>@yield('title', __('admin.admin.layouts.title'))</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark py-1">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                ...
                <span class="fs-1">{{ __('admin.admin.layouts.subtitle') }}</span>
            </a>
    ...
    <header class="bg-primary text-white py-3">
        <div class="container">
            <h1 class="mb-0">@yield('title', __('admin.admin.index.title'))</h1>
            @hasSection('subtitle')
    ...
    <footer class="bg-dark text-white py-3 mt-auto">
        <div class="container text-center">
            <small>
                {{ __('admin.admin.layouts.footer') }} {{ date('Y') }}
            </small>
        </div>
    </footer>
    <!-- footer -->
