...
<head>
    ...
    <title>@yield('title', __('app.layouts.admin.title'))</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark py-1">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                ...
                <span class="fs-1">{{ __('app.layouts.admin.subtitle') }}</span>
            </a>
    ...
    <header class="bg-primary text-white py-3">
        <div class="container">
            <h1 class="mb-0">@yield('title', __('app.layouts.admin.panel'))</h1>
            @hasSection('subtitle')
    ...
    <footer class="bg-dark text-white py-3 mt-auto">
        <div class="container text-center">
            <small>
                {{ __('app.layouts.admin.footer') }} {{ date('Y') }}
            </small>
        </div>
    </footer>
    <!-- footer -->
