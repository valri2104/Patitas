            ...
            <div class="col-md-10">
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <p><strong>{{ __('appointments.user') }}:</strong>
                                    {{ $viewData['appointment']->getUser()->getName() }}</p>
                            </div>
                            <div class="col-md-6">
                                <p><strong>{{ __('appointments.email') }}:</strong>
                                    {{ $viewData['appointment']->getUser()->getEmail() }}</p>
                            </div>
                        </div>

                        <div class="row mb-3">
                            <div class="col-md-6">
                                <p><strong>{{ __('appointments.pet_name') }}:</strong>
                                    {{ $viewData['appointment']->getPetName() }}</p>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <p><strong>{{ __('appointments.date') }}:</strong>
                                    {{ $viewData['appointment']->getDate() }}</p>
                            </div>
                            <div class="col-md-6">
                                <p><strong>{{ __('appointments.time') }}:</strong>
                                    {{ $viewData['appointment']->getTime() }}</p>
                            </div>
                        </div>
                    ...
                    <div class="card-footer bg-transparent">
                        <div class="d-grid gap-2 d-md-flex justify-content-md-between">
                            ...
                            <div>
                                <a href="{{ route('admin.appointment.edit', ['id' => $viewData['appointment']->getId()]) }}"
                                    class="btn btn-warning me-2">
                                    <i class="fas fa-edit me-2"></i>{{ __('appointments.edit') }}
                                </a>
                                <form
                                    action="{{ route('admin.appointment.destroy', ['id' => $viewData['appointment']->getId()]) }}"
