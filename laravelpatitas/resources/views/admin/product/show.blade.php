                ...
                <div class="row">
                    <div class="col-md-4 text-center mb-4">
                        <img src="{{ $viewData['product']->getImageUrl() ?: 'https://via.placeholder.com/400x400/cccccc/666666?text=Sin+Imagen' }}"
                            alt="{{ $viewData['product']->getName() }}" class="img-fluid rounded border">
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-8">
                                        <span
                                            class="badge bg-secondary">{{ __('admin.products.categories.' . $viewData['product']->getCategory()) }}</span>
                                    </dd>

                                    <dt class="col-sm-4">{{ __('admin.products.form.price') }}:</dt>
                                    <dd class="col-sm-8">
                                        <span
                                            class="fw-bold text-success">{{ number_format($viewData['product']->getPrice(), 0, ',', '.') }}
                                            {{ __('admin.common.currency') }}</span>
                                    </dd>

                                    <dt class="col-sm-4">{{ __('admin.products.form.stock') }}:</dt>
                                    <dd class="col-sm-8">
                                        <span
                                            class="badge {{ $viewData['product']->getStock() > 10 ? 'bg-success' : ($viewData['product']->getStock() > 0 ? 'bg-warning' : 'bg-danger') }}">
                            ...
                            <div class="col-md-6">
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-8">
                                        ...
                                        @else
                                            <span
                                                class="badge bg-danger">{{ __('admin.products.table.out_of_stock') }}</span>
                                        @endif
                                    </dd>
                                    ...
                                    <dd class="col-sm-8">
                                        <span
                                            class="badge {{ $viewData['product']->getCustomizable() ? 'bg-info' : 'bg-secondary' }}">
                                    ...
                                    <dd class="col-sm-8">
                                        {{ date('d/m/Y H:i', strtotime($viewData['product']->getCreatedAt())) }}</dd>

                                    <dt class="col-sm-4">{{ __('admin.products.show.updated_at') }}:</dt>
                                    <dd class="col-sm-8">
                                        {{ date('d/m/Y H:i', strtotime($viewData['product']->getUpdatedAt())) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
