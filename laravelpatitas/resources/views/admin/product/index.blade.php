        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">{{ __('admin.products.index.total_products', ['count' => count($viewData['products'])]) }}</h5>
                </div>
                            ...
                            <table class="table table-hover mb-0">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th scope="col" class="text-center">{{ __('admin.products.table.actions') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="fw-bold text-success">
                                                    {{ number_format($product->getPrice(), 0, ',', '.') }} {{ __('admin.common.currency') }}
                                                </span>
                                            </td>
                                            <td>
                                                <span class="badge {{ $product->getStock() > 10 ? 'bg-success' : ($product->getStock() > 0 ? 'bg-warning' : 'bg-danger') }}">
                                                    {{ $product->getStock() }}
                                                </span>
                                            </td>
                                            <td>
